...
function draw() {
  ...
  if(mouseIsPressed){
    noStroke();
    fill(177, 196, 235); // 눈 흰자
    ellipse(255, 158, 45, 20); // 왼쪽 눈
    stroke(0);
  }
  else{
    fill(255); // 눈 흰자
  ...
  if(mouseIsPressed){
    stroke(177, 196, 235);
    fill(177, 196, 235);
    ellipse(300, 260, 50, 40);
  }
  else{
    noFill();
    stroke(255, 0, 64);
    strokeWeight(4);
    arc(300, 230, 150, 60, radians(45), radians(135));
  }
